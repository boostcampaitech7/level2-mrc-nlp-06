...
utils_path = os.path.abspath(
    os.path.join(current_file_path, "../../../retrieval/dense/utils")
)
dense_path = os.path.abspath(
    os.path.join(current_file_path, "../../../retrieval/dense/src")
)
        ...
        match method:
            case "2-stages":
                ...
                hits = retriever.retrieve(
                    data_type=self.args_ret["data_type"],
                    stage=2,
                    topk=bi_config["topk"],
                )
