...
from hybrid_retrieval_bm import HybridRetrieval_BM
...
if __name__ == "__main__":
    ...
    for topk in [1, 5, 10, 15, 20]:
        ...
        #retriever.test(retriever_type="hybrid", query_or_dataset=full_ds, topk=topk)
        #retriever.retrieve(retriever_type="hybrid", query_or_dataset=query, topk=topk)
